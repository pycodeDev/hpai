    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			...
			<li class="nav-item">
				<a href="<?= base_url() ?>manager/dashboard/index" class="nav-link <?= $this->uri->segments[3] == 'index' ? 'active' : '' ?>">
					<i class="nav-icon fas fa-tachometer-alt"></i>
					<p>Beranda</p> 
				</a>
      </li>
			<li class="nav-item">
				<a href="<?= base_url() ?>manager/dashboard/prediksi_penjualan" class="nav-link <?= $this->uri->segments[3] == 'prediksi_penjualan' ? 'active' : '' ?>">
			...
			<a href="#" class="nav-link <?= $this->uri->segments[3] == 'laporan_produk' || $this->uri->segments[3] == 'laporan_stok_produk' || $this->uri->segments[3] == 'laporan_transaksi_penjualan' ? 'active' : '' ?>">
				...
				<ul class="nav nav-treeview">
					<li class="nav-item">
						<a href="<?= base_url() ?>manager/dashboard/laporan_produk" class="nav-link <?= $this->uri->segments[3] == 'laporan_produk' ? 'active' : '' ?>" >
							<i class="far fa-circle nav-icon ml-2"></i>
							<p>Produk</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url() ?>manager/dashboard/laporan_stok_produk" class="nav-link <?= $this->uri->segments[3] == 'laporan_stok_produk' ? 'active' : '' ?>">
							<i class="far fa-circle nav-icon ml-2"></i>
							<p>Stok Produk</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url() ?>manager/dashboard/laporan_transaksi_penjualan" class="nav-link <?= $this->uri->segments[3] == 'laporan_transaksi_penjualan' ? 'active' : '' ?>">
							<i class="far fa-circle nav-icon ml-2"></i>
                            ...
                            if ($val != "manager") {
                              ...
                              <?php if($is_active): ?>
                                <?php echo ucfirst($segments) ?>
                                  <?php else: ?>
                                <a href="<?php echo base_url() ?><?=$val == "dashboard" ?"manager/$val/index":"manager/dashboard/$val"?>"><?php echo ucfirst($segments) ?></a>
                              <?php endif; ?>
                          <?php    
                            }
                          endforeach;
