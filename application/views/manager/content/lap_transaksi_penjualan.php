            ...
            <div class="card-body">
              ...
              <table id="dataTable" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?=base_url()?>manager/dashboard/lap_transaksi_penjualan/<?=$det['id_prim']?>" class="btn btn-success <?=$det['bulan'] == 'Belum ada Transaksi' ? 'disabled': ''?>"><i class="fas fa-print"></i></a>
                    </td>
                </tr>
                <?php
                endforeach;
