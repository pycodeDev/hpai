    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header">
                <h3 class="card-title">Tambah Data Transaksi Penjualan</h3>
            </div>
                <form action="<?= base_url();?>admin/kelola_transaksi_penjualan/ptk" method="post">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <a  href="<?= base_url();?>admin/kelola_transaksi_penjualan/detail_transaksi_penjualan/<?=$det_prd->id_prim?>" type="submit" class="btn btn-danger">Kembali</a>
                    </div>
                </form>
        </div>
    </div>
